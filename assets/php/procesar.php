...
$nombreImg = '';
if ($im !== false) {
  $newNameImg = getNameImg();
  generateNewPost($newNameImg);
  imagejpeg($im, '../images/share/'.$newNameImg.'.jpg'); //guardar a server
...
function generateNewPost($nameImg){
  ...
  $content.= '<a href="http://pa-peru.com/digitas/plastico/paso1.html">Crear meme</a>';
  $content.= '</body>';
  $content.= '</html>';
